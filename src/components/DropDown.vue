...
export default {
  ...
  //     const {
  //       top, left, right, bottom,
  //     } = this.$refs.openBtn.getBoundingClientRect();
  //     const pos = {
  //       position: 'fixed',
  //     };
  //     if (this.window.height / 2 > top) {
  //       pos.top = `${bottom}px`;
  //     } else {
  //       pos.bottom = `${this.window.height - top}px`;
  //     }
  //     if (this.window.width / 2 > left) {
  //       pos.left = `${left}px`;
  //     } else {
  //       pos.right = `${this.window.width - right}px`;
  //     }
  //     return pos;
  //   },
  // },
  ...
  //       if (!this.hovered) this.isOpen = false;
  //     }, 100);
  //   },
  //   handleResize() {
  //     this.isOpen = false;
